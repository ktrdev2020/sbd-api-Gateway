...
using (var scope = app.Services.CreateScope())
{
    ...
    await db.Database.ExecuteSqlRawAsync(@"
        ...
        ('SuperAdmin','psnl','บริหารงานบุคคล','fas fa-id-card-alt','/administrator/psnl',3,TRUE,FALSE,NULL),
        ('SuperAdmin','schools','จัดการโรงเรียน','fas fa-school','/administrator/schools',4,TRUE,FALSE,NULL),
        ('SuperAdmin','areas','จัดการเขตพื้นที่','fas fa-map-marked-alt','/administrator/areas',5,TRUE,FALSE,NULL),
        ('SuperAdmin','modules','จัดการโมดูล','fas fa-puzzle-piece','/administrator/modules',6,TRUE,FALSE,NULL),
        ('SuperAdmin','positions','ตำแหน่ง','fas fa-id-badge','/administrator/positions',7,TRUE,FALSE,NULL),
        ('SuperAdmin','notifications','การแจ้งเตือน','fas fa-bell','/administrator/notifications',8,TRUE,FALSE,NULL),
        ('SuperAdmin','api-status','สถานะ API','fas fa-heartbeat','/administrator/api-status',9,TRUE,FALSE,NULL),
        ('SuperAdmin','minio','ที่เก็บไฟล์','fas fa-database','/administrator/minio',10,TRUE,FALSE,NULL),
        ('SuperAdmin','apikeys','API Keys','fas fa-key','/administrator/apikeys',11,TRUE,FALSE,NULL),
        ('SuperAdmin','redis','Redis','fas fa-bolt','/administrator/redis',12,TRUE,FALSE,NULL),
        ('SuperAdmin','rabbitmq','คิวงาน','fas fa-exchange-alt','/administrator/rabbitmq',13,TRUE,FALSE,NULL),
        ('SuperAdmin','signalr','SignalR','fas fa-satellite-dish','/administrator/signalr',14,TRUE,FALSE,NULL),
        ...
        ('AreaAdmin','payslip','สลิปเงินเดือน','fas fa-file-invoice-dollar','{{basePath}}/payslip',11,TRUE,FALSE,NULL),
        ...
        ('SchoolAdmin','org-structure','โครงสร้างองค์กร','fas fa-sitemap','{{basePath}}/org-structure',3,TRUE,FALSE,NULL),
        ('SchoolAdmin','students','นักเรียน','fas fa-user-graduate','{{basePath}}/students',4,TRUE,FALSE,NULL),
        ('SchoolAdmin','personnel','บุคลากร','fas fa-user-tie','{{basePath}}/personnel',5,TRUE,FALSE,NULL),
        ('SchoolAdmin','homeroom','ครูที่ปรึกษา','fas fa-chalkboard-teacher','{{basePath}}/homeroom',6,TRUE,FALSE,NULL),
        ('SchoolAdmin','users','จัดการผู้ใช้','fas fa-users-cog','{{basePath}}/users',7,TRUE,FALSE,NULL),
        ('SchoolAdmin','delegation','มอบหมายงาน','fas fa-id-badge','{{basePath}}/personnel/delegation',8,TRUE,FALSE,NULL),
        ('SchoolAdmin','modules','โมดูล','fas fa-puzzle-piece','{{basePath}}/modules',9,TRUE,FALSE,NULL),
        ('SchoolAdmin','settings','ตั้งค่า','fas fa-cog','{{basePath}}/settings',10,TRUE,FALSE,NULL),
        ('SchoolAdmin','payslip','สลิปเงินเดือน','fas fa-file-invoice-dollar','{{basePath}}/payslip',11,TRUE,FALSE,NULL),
        ...
        ('Teacher','payslip','สลิปเงินเดือน','fas fa-file-invoice-dollar','{{basePath}}/payslip',5,TRUE,FALSE,NULL),
