...
using (var scope = app.Services.CreateScope())
{
    ...
    await db.Database.ExecuteSqlRawAsync(@"
        ...
        ('SchoolAdmin','psnl','บริหารงานบุคคล','fas fa-id-card-alt','{{basePath}}/psnl',4,TRUE,FALSE,NULL),
        ('SchoolAdmin','users','จัดการผู้ใช้','fas fa-users-cog','{{basePath}}/users',5,TRUE,FALSE,NULL),
        ('SchoolAdmin','delegation','มอบหมายงาน','fas fa-id-badge','{{basePath}}/personnel/delegation',6,TRUE,FALSE,NULL),
        ('SchoolAdmin','modules','โมดูล','fas fa-puzzle-piece','{{basePath}}/modules',7,TRUE,FALSE,NULL),
        ('SchoolAdmin','settings','ตั้งค่า','fas fa-cog','{{basePath}}/settings',8,TRUE,FALSE,NULL),
